 ...
 *
 * Disassembly of dsdt.dat, Thu Aug 18 02:36:33 2022
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00007036 (28726)
 *     Revision         0x02
 *     Checksum         0x0C
 *     OEM ID           "ALASKA"
 *     OEM Table ID     "A M I "
...
DefinitionBlock ("", "DSDT", 2, "ALASKA", "A M I ", 0x01072009)
{
    ...
    Name (DTPT, Zero)
    Name (TTDP, One)
    Name (TPMB, 0xAB082000)
    Name (TPBS, 0x4000)
    Name (TPMC, 0xAB086000)
    Name (TPCS, 0x4000)
    Name (TPMM, 0xFD210510)
    Name (FTPM, 0xFD210510)
    Name (PPIM, 0xACC00B18)
    Name (PPIL, 0x1C)
    Name (AMDT, One)
    Name (TPMF, One)
    Name (PPIV, One)
    ...
    Scope (_SB.PCI0)
    {
        ...
        {
            "375016749376Genuine NVIDIA Certified SLI Ready Motherboard for MSI MEGX570ACE      A455-Copyright 2019 NVIDIA Corporation All Rights Reserved-274100472652(R)"
        })
        Device (WMI1)
        {
            Name (_HID, "PNP0C14" /* Windows Management Instrumentation Device */)  // _HID: Hardware ID
